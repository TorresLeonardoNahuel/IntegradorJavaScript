...
const imageUpload = require ('../middlewares/cargarImagen.js');

router.get('/' , controller.listar);

router.get('/:id' , controller.detalle);

router.post('/' , checkLogin, imageUpload.single('imagen'), controller.crear);

router.patch('/:id' , checkLogin, imageUpload.single('imagen'), controller.actualizar);
